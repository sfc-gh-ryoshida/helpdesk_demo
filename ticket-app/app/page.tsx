...
export default function Home() {
  ...
  }, [statusFilter, urgencyFilter, searchQuery, currentPage]);
          ...
          <Card>
            ...
            <CardContent>
              {loading ? (
                ...
                <p className="text-2xl font-bold text-red-600">{stats.highUrgency}</p>
              )}
            </CardContent>
          </Card>
        </div>
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-between px-4 py-3 border-t">
                <p className="text-sm text-muted-foreground">
                  ...
                  {Math.min(currentPage * PAGE_SIZE, totalCount)}件
                </p>
